...
public class CastRemoteDisplayManagerEditor : Editor {
  public override void OnInspectorGUI() {
    ...
    manager.RemoteAudioListener = (CastRemoteDisplayAudioListener) EditorGUILayout.ObjectField(
        "Remote Audio Listener", manager.RemoteAudioListener, typeof(CastRemoteDisplayAudioListener),
        true);
    ...
    EditorGUILayout.PropertyField(serializedObject.FindProperty("castDevicesUpdatedEvent"), true);
    EditorGUILayout.PropertyField(serializedObject.FindProperty("remoteDisplaySessionStartEvent"),
        true);
    EditorGUILayout.PropertyField(serializedObject.FindProperty("remoteDisplaySessionEndEvent"),
        true);
    EditorGUILayout.PropertyField(serializedObject.FindProperty("remoteDisplayErrorEvent"), true);
